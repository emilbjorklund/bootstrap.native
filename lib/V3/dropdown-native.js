...
var Dropdown = function( element, option ) {
  ...
  var self = this, children = 'children',
    ...
    toggleDismiss = function(){
      ...
      // The current implementation of event delegation in on()
      // does not allow for the useCapture flag, which is (sadly, still)
      // necessary when delegating focus events.
      // See: https://www.quirksmode.org/blog/archives/2008/04/delegating_the.html
      // You could probably use some variation of focusin, but
      // I think it would potentially require more code.
      if (type === on) {
        document.addEventListener(focusEvent, dismissHandler, true);
      } else {
        document.removeEventListener(focusEvent, dismissHandler, true);
      }
    },
